...
export const AddCarPageStyles = {
  ...
  pageContainer:
  "min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 p-4 sm:p-6",
  ...
  // Header
  headerContainer: "relative mt-24 mb-8 text-center",

  headerDivider: "flex flex-col items-center",

  headerDividerLine:
    "h-1 w-full mb-3 bg-gradient-to-r from-orange-500 to-amber-500 rounded-full",

  title:
    "text-4xl font-extrabold py-2 text-white sm:text-5xl mb-3 tracking-wide",

  titleGradient:
    "text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-amber-400",

  subtitle: "text-lg text-gray-300 max-w-2xl mx-auto",
