import React, { Children, useEffect, useMemo, useState, useCallback } from "react";
import { BookingPageStyles, statusConfig } from "../assets/dummyStyles";
import axios from "axios";
import {
  FaCalendarAlt, FaChevronDown, FaEdit, FaUser, FaEnvelope, FaPhone, 
  FaCreditCard, FaMapMarkerAlt, FaCity, FaGlobeAsia, FaMapPin, FaCar,
  FaUserFriends, FaGasPump, FaTachometerAlt, FaCheckCircle, FaSearch, FaSync, FaFilter
} from "react-icons/fa";
...
const Panel = ({ title, icon, children }) => (
  <div className={BookingPageStyles.panel}>
    <h3 className={BookingPageStyles.panelTitle}>{icon}</h3>
...
const BookingCartHeader = ({ booking, onToggleDetails, isExpanded }) => (
...
const NoBookingView = ({ onResetFilters }) => (
    ...
    <div className={BookingPageStyles.pageContainer}>
      ...
      <div className="space-y-4">
        ...
        {filterBookings.length === 0 && (
          <NoBookingView onResetFilters={handleResetFilters} />
        )}
      </div>
    </div>
  );
