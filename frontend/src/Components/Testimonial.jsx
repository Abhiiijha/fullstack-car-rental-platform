...
import { FaQuoteLeft, FaCar, FaStar } from "react-icons/fa";
    ...
    <div className={styles.container}>
      ...
      <div className={styles.ctaContainer}>
        ...
        <p className={styles.ctaText}>
          Join thousands of satisfied customers who have experienced our premium
          fleet and exceptional services.
        </p>
