...
export const heroStyles = {
  ...
  background: "absolute inset-0 transform-gpu will-change-transform",
  gradientOverlay:
...
export const carPageStyles = {
  pageContainer:
    "relative min-h-screen pt-24 sm:pt-28 md:pt-32 pb-8 px-4 sm:px-6 lg:px-8 overflow-hidden bg-gradient-to-b from-gray-950 to-black",
